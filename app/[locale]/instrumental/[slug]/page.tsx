...
export function generateStaticParams() {
  return childSlugs("instrumental").map((slug) => ({ slug }));
}
...
export async function generateMetadata({
  ...
  const c = getPageContent(`instrumental/${slug}`, locale as Locale);
  return {
    title: c?.title,
    description: c ? excerpt(c.body) : undefined,
    alternates: localeAlternates(`/instrumental/${slug}`, locale),
  };
}
