...
Phase 6 sends booking confirmations by SMS/email, order confirmations by email, staff alerts
for new bookings/orders, and appointment reminders at 24 hours and 2 hours before the booked
time. Configure one email provider and one SMS provider in `.env`:
